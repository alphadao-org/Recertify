...
export function loadAddAdmin(slice: Slice) {
  const sc_0 = slice;
  if (sc_0.loadUint(32) !== 3599441591) {
...
export function loadMint(slice: Slice) {
  const sc_0 = slice;
  if (sc_0.loadUint(32) !== 2415581732) {
    throw Error("Invalid prefix");
  }
...
export function loadCertificationNFT$Data(slice: Slice) {
  const sc_0 = slice;
  const _owner = sc_0.loadAddress();
  const _admins = Dictionary.load(
    Dictionary.Keys.Address(),
    Dictionary.Values.Bool(),
    sc_0,
  );
  const _tokens = Dictionary.load(
    Dictionary.Keys.BigInt(257),
    dictValueParserToken(),
    sc_0,
  );
  ...
  const _base_uri = sc_0.loadStringRefTail();
  return {
    $$type: "CertificationNFT$Data" as const,
    owner: _owner,
    admins: _admins,
    tokens: _tokens,
    total: _total,
...
export function loadTupleCertificationNFT$Data(source: TupleReader) {
  const _owner = source.readAddress();
  const _admins = Dictionary.loadDirect(
    Dictionary.Keys.Address(),
    Dictionary.Values.Bool(),
    source.readCellOpt(),
  );
  const _tokens = Dictionary.loadDirect(
    Dictionary.Keys.BigInt(257),
    dictValueParserToken(),
    source.readCellOpt(),
  );
...
export function dictValueParserCertificationNFT$Data(): DictionaryValue<CertificationNFT$Data> {
  return {
    serialize: (src, builder) => {
      builder.storeRef(
        beginCell().store(storeCertificationNFT$Data(src)).endCell(),
      );
    },
    parse: (src) => {
...
async function CertificationNFT_init(owner: Address, base_uri: string) {
  const __code = Cell.fromHex(
    "",
  );
  const builder = beginCell();
  builder.storeUint(0, 1);
  initCertificationNFT_init_args({
    $$type: "CertificationNFT_init_args",
    owner,
    base_uri,
  })(builder);
...
const CertificationNFT_types: ABIType[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "admins", type: { kind: "dict", key: "address", value: "bool" } },
      {
        name: "tokens",
        type: { kind: "dict", key: "int", value: "Token", valueFormat: "ref" },
      },
      {
        name: "total",
        type: { kind: "simple", type: "int", optional: false, format: 257 },
